...
fn status_for(error: &AppError) -> StatusCode {
    match error {
        ...
        AppError::EmailNotVerified => StatusCode::BAD_REQUEST,
        ...
        AppError::EmailVerificationExpired => StatusCode::BAD_REQUEST,
        AppError::EmailVerificationInvalid => StatusCode::BAD_REQUEST,
        AppError::ImageNotFound => StatusCode::NOT_FOUND,
        AppError::BackupNotFound => StatusCode::NOT_FOUND,
        AppError::InvalidImageFormat => StatusCode::BAD_REQUEST,
        AppError::Forbidden => StatusCode::FORBIDDEN,
        AppError::AdminRequired => StatusCode::FORBIDDEN,
        AppError::AppNotInstalled => StatusCode::SERVICE_UNAVAILABLE,
        AppError::AppAlreadyInstalled => StatusCode::CONFLICT,
